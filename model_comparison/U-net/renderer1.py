...
pretrained_policy_path ="C:\\Users\\IIISI\\OneDrive\\Documents\\DLF\\atari_breakout_dqn_pytorch\\dqn\\trained_policies\\trained_policy_network.pt" #"trained_policies/trained_policy_network.pt"
...
def evaluate(policy_net, device, environment, n_actions, num_episode):
    ...
    for i in range(num_episode):
        ...
        with h5py.File('C:\\Users\\IIISI\\OneDrive\\Documents\\DLF\\atari_breakout_dqn_pytorch\\dqn\\state_data.h5', 'w') as state_hdf, h5py.File('C:\\Users\\IIISI\\OneDrive\\Documents\\DLF\\atari_breakout_dqn_pytorch\\dqn\\action_data.h5', 'w') as action_hdf:
            FIX_MY_STEP=2000
            FIX_MY_BRAIN=FIX_MY_STEP
            while not done:
                FIX_MY_BRAIN-=1
                print(FIX_MY_BRAIN)
                if FIX_MY_BRAIN<0:
                ...
                state_hdf.create_dataset(f'state_{step}', data=state)
                action_hdf.create_dataset(f'action_{step}', data=action)
